#!/usr/bin/python3
"""
This recursive function  queries the Reddit API and return
...
def recurse(subreddit, hot_list=[], after=None):
    '''
    This recursive function that queries the Reddit API and returns a list
